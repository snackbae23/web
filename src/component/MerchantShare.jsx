...
const MerchantShare = () => {
    ...
    return (
        <div className='w-full h-0 relative'>
            <div className={`fixed bottom-0 left-[50%] translate-x-[-50%] max-w-[400px] w-full  hideScroller h-fit z-[3000] bg-transparent comment ${shareVisible ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
