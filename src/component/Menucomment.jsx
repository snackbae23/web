...
const Menucomment = () => {
    ...
    return (
        <div className=' relative w-full h-0 '>
            <div
                className={` border-2 rounded-t-3xl fixed bottom-0 left-[50%] z-[5000] translate-x-[-50%] max-w-[400px] h-[80vh] overflow-scroll hideScroller w-full comment ${commentVisible ? 'translate-y-0 opacity-100' : 'translate-y-full opacity-0'}`}>
                ...
                <div className='w-full sticky top-0 bg-white z-[100] pt-[1rem] border-b-2'>
                    ...
                    <div className='flex justify-evenly items-center my-[1rem]'>
                        <button
                            ...
                            className={`${newone && ('bg-[#FFD628]')} px-[1.2rem] py-[.5rem] rounded-md font-[500] text-[1rem] leading-[1.15rem] border-2`}>New</button>
                        <button
                            onClick={() => {
                                setGood(false);
                                setNewone(false);
                            ...
                            className={` ${notlikedone && ('bg-[#FFD628]')} px-[1.2rem] py-[.5rem] rounded-md font-[500] text-[1rem] leading-[1.15rem] border-2`}>Not Liked</button>
                        <button
                            onClick={() => {
                                setGood(!goodone);
                                setNewone(false);
                            ...
                            className={` ${goodone && ('bg-[#FFD628]')} px-[1.2rem] py-[.5rem] rounded-md font-[500] text-[1rem] leading-[1.15rem] border-2`}>Liked</button>
                        <button
                            onClick={() => {
                                setGood(false);
                                setNewone(false);
                            ...
                            className={` ${musttryone && ('bg-[#FFD628]')}  px-[1.2rem] py-[.5rem] rounded-md font-[500] text-[1rem] leading-[1.15rem] border-2`}>Must try</button>
                    </div>
                </div>
