    ...
    <div className="w-full h-fit ">
      ...
      <div className="bg-[#101010] w-full h-fit relative z-[100]">
        ...
        <img
          src={bgHero}
          alt="bg-effect"
          className="absolute top-0 w-full h-full sm:block hidden"
        />
        {/* demoPage */}
        {seeDemo && (
          <div className="w-[90%] mx-auto max-w-[613px] h-fit shadow-lg absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] z-[200] bg-white rounded-md">
            ...
            <form
              ...
              className="w-full sm:w-[80%] h-fit mx-auto mt-[1rem] p-[2rem]"
            >
              <label
                htmlFor="brandName"
                className="block mb-[.5rem] font-[500]"
              >
                Brand Name
              </label>
              <input
                ...
                required
              />
              <label htmlFor="email" className="block mb-[.5rem] font-[500]">
                Email
              </label>
              <input
                type="email"
              ...
              <button
                type="submit"
                className="bg-[#004AAD] text-[#FFFFFF] px-[2rem] py-[.5rem] rounded-md mt-[.5rem] relative left-[50%] translate-x-[-50%]"
              >
                Submit
              </button>
            </form>
      ...
      <div className="w-full h-fit py-[2rem] bg-[#0F172A] relative">
        <div className="w-[90%] h-fit mx-auto pt-[2rem] relative mb-[1rem]">
          <div className="w-full sm:w-[40%] h-fit z-[100] relative ">
            ...
            />
            <p className="w-full text-[2rem] sm:text-[3rem] z-[101] font-[700] font-inter leading-[3rem] lsm:eading-[4rem] text-[#ECFEFF] pl-[5rem] pt-[4rem]">
              Real Opinion from Real Customers
            </p>
            <p className="text-[.9rem] sm:text-[1rem] z-[101] font-[400] font-inter sm:leading-[2.5rem] leading-[1.4rem] text-[#E5E7EB] pl-[5rem] ">
        ...
        <div className="w-full overflow-hidden">
          <div className="w-[calc(200px*18)] flex scrollleftanimation">
            <img
              src={slider1}
              alt="slider1"
              className="w-[250px] aspect-auto mx-[.5rem]"
            />
            <img
              src={slider2}
              alt="slider1"
      ...
      <div id="elementId" className="w-full h-fit bg-[#101010] md:p-[2rem]">
        <p className="bg-white text-[#004AAD] px-[1.5rem] py-[.5rem] inline-block mt-[3rem] ml-[3rem] rounded-3xl font-Roboto font-[600]">
          For Customer
        </p>

        <div className="w-fit mx-auto text-center mt-[2rem]">
          <p className=" font-inter font-[700] text-[2.4rem] md:text-[3rem] leading-[3.2rem] md:leading-[4.5rem] tracking-tighter text-[#E5E7EB]">
            SnackBAE Features
          </p>
          <p className=" font-inter font-[400] md:text-[1.2rem] leading-[1.6rem] tracking-tighter text-[#D1D5DB]">
            Indulge in the ultimate dining experience with SnackBae!
          </p>
        </div>
        ...
        <div className="w-[70%] md:w-[90%] mx-auto h-fit flex md:flex-row flex-col md:items-start items-center justify-evenly gap-[2rem] mt-[4rem] pb-[2rem] ">
          <div className="w-full md:w-[33%] h-fit text-center">
            <img
              src={foodicon}
              alt="foodicon"
              className=" relative left-[50%] translate-x-[-50%] mb-[1rem]"
            />
            <p className="font-inter font-[600] text-[1.8rem] leading-[2.4rem] text-[#E5E7EB]">
              Beat Decision Fatigue
            </p>
            <p className="font-inter font-[400] text-[.9rem] leading-[1.6rem] text-[#D1D5DB]">
              Say goodbye to decision fatigue! Get community-centred food
              recommendations tailored just for you, saving precious time on
          ...
          <div className="w-full md:w-[33%] h-fit text-center">
            ...
            <p className="font-inter font-[400] text-[.9rem]  leading-[1.6rem] text-[#D1D5DB]">
              Play games on Snackbae and earn exiciting discounts and freebies
          ...
          <div className="w-full md:w-[33%] h-fit text-center">
            ...
            <p className="font-inter font-[400] text-[.9rem] leading-[1.6rem] text-[#D1D5DB]">
              Share your expertise! Recommend dishes, eateries, and help others
              uncover the best sellers and hidden gems of Kolkata's vibrant food
              scene.
            </p>
          </div>
        </div>
      ...
      <div className="bg-[#004AAD] w-full h-fit  flex md:flex-row flex-col justify-around items-center relative ">
        <div className="md:w-[70%] lg:w-[50%] h-fit p-[1rem] ">
          <p className="bg-white text-[#004AAD] px-[1.5rem] py-[.5rem] inline-block  rounded-3xl font-Roboto font-[600] mb-[1rem]">
            For Partners
          </p>
          <p className=" font-inter font-[700] text-[2.4rem] md:text-[3rem] leading-[3.2rem] md:leading-[4.5rem] tracking-tighter text-[#E5E7EB]">
            Elevate Your Business: Revolutionize Customer Relations with
            SnackBae!
          </p>
          <p className=" font-inter font-[400] md:text-[1.1rem] leading-[1.6rem] tracking-tighter text-[#D1D5DB]">
            SnackBae is here to transform the way you engage with your customers
            and drive lasting relationships.
          </p>
          <Link
            onClick={scrollSmooth}
            to="/joinAsPartner"
            className=" mt-[1rem] text-white bg-[#004AAD] px-[1.5rem] py-[.5rem] inline-block  rounded-3xl font-Roboto font-[600] border-2 border-white"
          >
            Learn More
          </Link>
        </div>
        ...
        <img
          src={mobileImage}
          alt="mobileImage"
          className="md:block hidden w-[45%] lg:h-full aspect-auto"
        />
        {/* small-screen */}
        <div className="md:hidden w-full h-[400px] overflow-hidden flex justify-center ">
          <img
            src={PhoneMockup2Image}
            alt="PhoneMockup2Image"
