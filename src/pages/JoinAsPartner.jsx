      ...
      <div className='md:w-[90%] mx-auto flex lg:flex-row flex-col-reverse justify-evenly items-center min-h-[100vh] '>
        <div className='lg:w-[50%] h-fit p-[2rem]'>
          ...
          <div className='flex justify-start gap-[2rem] items-center w-full py-[1rem] '>
            ...
            <Link to='https://snackbaeuser-snackbaes-projects.vercel.app/' className='border-2 border-[#004AAD] text-[#004AAD] font-Roboto font-[400] text-[16px] leading-[18.75px] tracking-tight px-[1.5rem] py-[.7rem] rounded-md '>Login</Link>
          </div>
        </div>

        <img src={joinAsPartner} alt='joinAsPartner' loading='lazy' className='sm:w-[70%] lg:w-[40%] aspect-square mx-auto' />
      </div>
